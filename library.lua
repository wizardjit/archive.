...
local drawing  = loadstring(request({Url = 'https://raw.githubusercontent.com/wizardjit/archive./refs/heads/main/drawing.lua', Method = 'GET'}).Body)()
local tween = loadstring(request({Url = 'https://raw.githubusercontent.com/wizardjit/archive./refs/heads/main/tween.lua', Method = 'GET'}).Body)()
